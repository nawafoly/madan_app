        ...
        <section className="flex flex-1 flex-col justify-center">
          <div className="mb-7 flex justify-center">
            <div className="flex h-24 w-24 items-center justify-center rounded-[28px] bg-white shadow-[0_14px_44px_rgba(0,0,0,0.08)] ring-1 ring-black/5">
              <img
                src="/habat-alwaraq-logo.svg?v=20260906"
                alt="حبات الورق"
          ...
          <button
            ...
            className="mt-8 h-14 w-full rounded-2xl bg-black px-5 text-base font-extrabold text-white shadow-lg transition active:scale-[0.99]"
          >
          ...
          {!installed && ios && !safari ? (
            <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm font-semibold leading-6 text-amber-950">
              ...
              <button
                ...
                className="mt-3 block w-full rounded-xl border border-amber-300 bg-white px-4 py-3 font-extrabold"
              >
                ...
                <>
                  ...
                  <div className="mt-4 space-y-3">
                    <div className="flex items-center gap-3 rounded-2xl bg-[#f7f7f5] p-4">
                      ...
                      <p className="text-sm font-bold leading-6">اضغط زر المشاركة في Safari <span dir="ltr">↑</span></p>
                    </div>
                    <div className="flex items-center gap-3 rounded-2xl bg-[#f7f7f5] p-4">
                      ...
                      <p className="text-sm font-bold leading-6">اختر «إضافة إلى الشاشة الرئيسية»، ثم اضغط «إضافة».</p>
                    </div>
                  </div>
                  <p className="mt-4 text-xs font-semibold leading-5 text-black/45">
                    بعد الإضافة افتح حبات الورق من الأيقونة الجديدة على الشاشة الرئيسية.
                  </p>
                </>
              ) : (
                <>
          ...
          {installed ? (
            <div className="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-center text-sm font-extrabold text-emerald-950">
              حبات الورق يعمل الآن كتطبيق مستقل على هذا الجهاز.
            </div>
          ) : null}
        </section>

        <p className="pt-7 text-center text-[11px] font-semibold leading-5 text-black/35">
          لا يحتاج التثبيت إلى App Store، وبيانات تسجيل الدخول تبقى داخل نظام حبات الورق.
        </p>
      </div>
    </main>
  );
