...
> = {
  home: [
    ...
    mediaField("homeServicesIllustration", "Services grid illustration", "Features & Services Grid", "image", "/og.png", "Home services grid illustration"),
  ...
  about: [
    mediaField("aboutHeroImage", "Hero image", "Hero Section", "image", "/og.png", "About page hero image"),
    ...
    mediaField("aboutStoryParallax", "Story parallax background", "Backgrounds & Banners", "image", "/HOOM-HERO.png", "About story parallax background"),
  ...
  projects: [
    mediaField("projectsHeroImage", "Hero image", "Hero Section", "image", "/HOOM-HERO.png", "Projects page hero image"),
