...
const STEP_META: Record<InvestmentRequestStageKey, StepMeta> = {
  ...
  contract_verified: {
    title: "اعتماد العقد",
    descriptions: {
      done: "تم اعتماد العقد، وتبقى خطوة تفعيل الاستثمار رسميًا.",
      current: "تم اعتماد العقد، ويجري الآن استكمال إجراءات التفعيل الرسمي.",
      pending: "بعد اعتماد العقد، سيتم الانتقال إلى خطوة تفعيل الاستثمار رسميًا.",
    },
    icon: ShieldCheck,
  },
};
