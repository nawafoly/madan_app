    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/92 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/92">
      <div className="mx-auto flex min-h-16 w-full max-w-none items-center justify-between gap-3 px-4 py-2.5 sm:px-6 lg:px-8 2xl:px-10">
        ...
        <div className="flex shrink-0 items-center justify-end gap-1.5 sm:gap-2">
          ...
          {showNotifications ? (
            <NotificationBell triggerClassName="h-10 w-10 rounded-full border border-slate-200 bg-white p-0 text-slate-700 shadow-none hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800" />
          ) : null}
          ...
          <Button
            ...
            className="h-10 rounded-full border-slate-200 bg-white px-3 text-sm shadow-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800 sm:px-4"
          ...
          {switchHref && switchLabel && SwitchIcon ? (
            <Link href={switchHref}>
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-10 rounded-full border-amber-300/80 bg-amber-50 px-3 text-sm font-semibold text-slate-900 shadow-none hover:border-amber-400 hover:bg-amber-100 dark:border-amber-400/45 dark:bg-amber-400/10 dark:text-amber-100 dark:hover:bg-amber-400/16 sm:px-4"
                aria-label={switchLabel}
              >
                <SwitchIcon className="h-4 w-4 shrink-0 text-amber-600 dark:text-amber-300" />
          ...
          {onLogout ? (
            <Button
              ...
              className="h-10 rounded-full border-red-200 bg-red-50/80 px-2.5 font-semibold text-red-600 shadow-none hover:border-red-300 hover:bg-red-100/80 hover:text-red-700 dark:border-red-400/30 dark:bg-red-500/10 dark:text-red-200 dark:hover:bg-red-500/16 sm:px-3.5"
