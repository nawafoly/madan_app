...
function run(label, command, args) {
  console.log(`\n[workforce-payroll-readiness-gate] ${label}`);
...
node("integrate payroll readiness", ["scripts/integrate-workforce-payroll-readiness.mjs"]);
node("syntax: payroll readiness", ["--check", "workers/workforce-payroll-readiness.js"]);
...
console.log("\n[workforce-payroll-readiness-gate] PASS - readiness engine integration, regressions, TypeScript, and build completed.");
